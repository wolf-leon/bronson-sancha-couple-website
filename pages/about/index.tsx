    ...
    <DefaultLayout>
      ...
      <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
        ...
        <div className="w-full max-w-lg md:max-w-2xl lg:max-w-3xl p-6 bg-white rounded-lg shadow-lg flex flex-col items-center text-center mt-8">
          ...
          <p className="text-base text-gray-600 my-4">
            Kind-hearted individual with a strong sense of responsibility. He is
            always willing to lend a helping hand and values honesty and
            integrity above all. Bronson&apos;s positive outlook on life and his
            ability to inspire others make him a cherished friend and partner.
            <br />
            <br />
            His adventurous spirit leads him to explore new places and
            experiences, and he finds joy in the simple things in life.
          </p>
          ...
          <div className="mt-4 p-4 bg-gray-100 rounded-lg">
            <p className="italic">
              &quot;Sancha My Love, Every day with you is a new adventure. I
      ...
      <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
        ...
        <div className="w-full max-w-lg md:max-w-2xl lg:max-w-3xl p-6 bg-white rounded-lg shadow-lg flex flex-col items-center text-center mt-8">
          ...
          <p className="text-base text-gray-600 my-4">
            Sancha is a compassionate and intelligent woman who brings joy and
            warmth to everyone she meets. Her empathetic nature and ability to
            understand others make her an amazing friend and partner.
            Sancha&apos;s enthusiasm for life and her unwavering support inspire
            those around her.
            <br />
            <br />
            Her love for art and creativity is evident in everything she does,
            from her hobbies to her endeavors.
          </p>
          <h3 className="text-2xl font-medium my-2">Hobbies</h3>
          <ul className="list-disc list-inside mb-4 text-center">
            <li>Dancing</li>
          ...
          <div className="mt-4 p-4 bg-gray-100 rounded-lg">
            <p className="italic">
              &quot;Bronson, my love, you are my rock and my inspiration.
              Together, we can conquer anything and create a beautiful
              future.&quot;
            </p>
          </div>
        </div>
